...
% y_mix - wartości double wielomianu określonego przez double(coef_vpa)
    ...
    V_double = get_vandermonde_matrix(x_nodes); % TODO
    coef_double = V_double\y_nodes; % TODO
    ...
    x_nodes_vpa = x_nodes_vpa';
    y_nodes_vpa = f(x_nodes_vpa);

    V_vpa = get_vandermonde_matrix_vpa(x_nodes_vpa); % TODO
    coef_vpa = V_vpa\y_nodes_vpa; % TODO
